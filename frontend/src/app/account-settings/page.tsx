  ...
  return (
    <div className="min-h-screen bg-white text-[#222222] flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-[#EBEBEB] px-6 sm:px-12 py-4 flex items-center justify-between">
        {/* Left: Official Single Bélo Icon in Charcoal matching Screenshot 1 */}
        <Link href="/" className="flex items-center group cursor-pointer" title="Airbnb Home">
          <svg
            className="h-8 w-8 text-[#222222] transition-transform group-hover:scale-105"
            viewBox="0 0 32 32"
            fill="currentColor"
          >
