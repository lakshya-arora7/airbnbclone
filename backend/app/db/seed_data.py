...
def seed_database(db: Session = None) -> dict:
    """
    Unified database initialization & seeding engine.
    Ensures tables, personas, 5 authentic listings, bookings, reviews, and test conversations.
    """
    ...
    try:
        # 1. Clean existing records for a fresh, deterministic seed
        ...
        users = [
            ...
            User(
                ...
                role="GUEST",
                is_superhost=False,
                host_since="February 2023",
                bio="Design enthusiast & frequent traveler."
            )
        ]
        for u in users:
            db.add(u)
        ...
        # 3. Exactly 5 authentic listings
        listings_data = [
            {
                "id": 1,
                "host_id": 2,
        ...
        reviews = [
            Review(
                ...
                location_rating=5.0,
                value_rating=5.0,
                comment="Loved staying here! Spotless apartment, superfast WiFi, and Ravi was super responsive and helpful.",
            ...
            Review(
                ...
                location_rating=5.0,
                value_rating=5.0,
                comment="Prime location in Sector 63 with a peaceful sunset balcony. 5-star experience!",
            ...
            Review(
                ...
                location_rating=5.0,
                value_rating=5.0,
                comment="The private pool and lawn were incredible. Perfect weekend getaway with complete privacy.",
            ...
            Review(
                ...
                location_rating=5.0,
                value_rating=5.0,
                comment="Breathtaking skyline views and gorgeous interiors. Seamless check-in.",
        ...
        # 6. Sample real-time message thread between Guest Lakshya and Host Ravi
        sample_messages = [
            Message(
                id=1,
                sender_id=1,
                recipient_id=2,
                listing_id=1,
                text="Hi Ravi! Looking forward to our stay. Could we arrange an early check-in around 1 PM?",
                is_read=True,
            ...
            Message(
                ...
                recipient_id=1,
                listing_id=1,
                text="Hello Lakshya! Absolutely, 1 PM works perfectly. I will have the keys ready for you.",
                is_read=True,
                created_at=datetime.now(timezone.utc) - timedelta(days=2, hours=22)
            )
        ]
        ...
        print(f"[Seed] Successfully seeded unified database: {stats}")
        return stats
